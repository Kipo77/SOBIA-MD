...
module.exports = {
    ...
    CAPTION: process.env.CAPTION || "POWERED BY Tech.jacob BUTT",
    ...
    ALIVE_MSG: process.env.ALIVE_MSG || "HII DEAR IM ONLINE I'M Tech.jacob WHATSAPP BOT 😊♻️",
    ...
    DEV: process.env.DEV || "254746599745",//replace with your whatsapp number        
    ANTI_VV: process.env.ANTI_VV || "true",// true for anti once view 
    ANTI_DEL_PATH: process.env.ANTI_DEL_PATH || "log", // change it to 'same' if you want to resend deleted message in same chat
    OWNER_REACT: process.env.OWNER_REACT || "true",
    READ_CMD: process.env.READ_CMD || "true",
    BOT_NAME: process.env.BOT_NAME || "➺TechjacobɳƭBUTT_࿐",
